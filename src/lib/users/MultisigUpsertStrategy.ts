...
export default class MultisigUpdateStrategy implements UserUpsertStrategy {
  ...
  // Somehow our TS setup prevents us from using the default import. It interprets `SafeApiKit` as a namespace.
  // Hence the explicit `default` here and on the instantiation further down.b
